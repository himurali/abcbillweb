...
export default function TfeatureEconomy() {
  const myStyle1 = {};

  return (
    <div>
      <section className="font-sans antialiased w-full bg-green-200 py-8">
        <div className="container mx-auto">
          <div className="py-8 w-full mx-auto">
            <h1 className="text-indigo-darkest text-4xl text-center font-normal">
              Economy.
            </h1>
            <h2 className="text-blue-600 text-4xl text-center font-normal">
			building a stronger, healthier, and more sustainable economy{" "}
            </h2>
                  ...
                  <div className="mt-8 mx-auto w-2/3">
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
                        Bolster Indias leadership in Active Mobility
                        Manufacturing by Funding for AM startups and subsidy for
                        businesses to scale active mobility
                      </span>
                    </div>
                    <div className="flex items-center mb-4">
                      <span className="inline-flex bg-green-lighter rounded-full mr-4 p-1">
                      ...
                      <span className="text-grey-darker">
                        {" "}
                        Improve Customer Experiences for delivering active
                        mobility
                      </span>
                    </div>
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
                        {" "}
                        Create new differentiated Product and Service Offerings
                        in active mobility
                      </span>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
                        {" "}
                        Digital-Outcome-Driven Metrics for Manufacturing in
                        active mobility
                      </span>
                    </div>
                    <div className="flex items-center mb-4">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
                        {" "}
                        Create and Grow in new markets in active mobility like
                        bicycle tourism and active travel{" "}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
                        Strengthen domestic AM manufacturing, design and
                        research, fortify the economy and national security, and
                        reinforce India's supply chains for active mobility
                      </span>
                    </div>
                  </div>
                </div>
