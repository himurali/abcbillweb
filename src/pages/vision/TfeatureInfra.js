...
export default function TfeatureInfra() {
  const myStyle1 = {};
      ...
      <section className="font-sans antialiased w-full bg-yellow-200 py-8">
        <div className="container mx-auto">
          <div className="py-8 w-full mx-auto">
            <h1 className="text-indigo-800 text-4xl text-center font-normal">
              Infrastructure.
            </h1>
                ...
                <div className="py-8">
                  ...
                  <div className="mt-8 mx-auto w-2/3">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
					  Improved street design that prioritizes active transportation, including traffic calming measures, speed reduction, and road diets.
                      </span>
                    </div>
                  ...
                  <table className="w-3/4 mx-auto text-white text-center">
                    <tbody>
                      <tr>
                        ...
                        <td className="px-2 py-4 border border-indigo-dark">
						Establish a dedicated active transportation budget for one city in each state.
                        </td>
                      </tr>
                      <tr>
                        <td className="px-2 py-4 border border-indigo-dark">
                          Create and implement design guidelines and standards in a Tier 3 city .
                        </td>
                        <td className="px-2 py-4 border border-indigo-dark">
                      ...
                      <tr>
                        <td className="px-2 py-4 border border-indigo-dark">
						Publish infra design strategies & patterns to create active transportation infrastructure that is visually appealing, environmentally friendly, and cost-effective.
                        </td>
                        <td className="px-2 py-4 border border-indigo-dark">
                            Publish  innovative and sustainable materials guidelines  for active mobility infrastructure.
                        </td>
                      </tr>
                    </tbody>
                  </table>
