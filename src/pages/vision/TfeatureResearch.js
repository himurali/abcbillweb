      ...
      <section className="font-sans antialiased w-full bg-green-500 py-8">
        <div className="container mx-auto">
          <div className="py-8 w-full mx-auto">
			...
			Valuable insights into the health,environmental, economic  & social benefits of  Active mobility
            </h2>
                  ...
                  <div className="mt-8 mx-auto w-2/3">
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-grey-darker">
                        Improved public engagement to scale active mobility
                      </span>
                    </div>
                    <div className="flex items-center mb-4">
                      <span className="inline-flex bg-green-lighter rounded-full mr-4 p-1">
                      ...
                      <span className="text-grey-darker">
                        {" "}
                        Increased active transportation targets for delivering
                        active mobility
                      </span>
                    </div>
                    <div className="flex items-center mb-4">
                  ...
                  <table className="w-3/4 mx-auto text-white text-center">
                    <tbody>
                      ...
                      <tr>
                        <td className="px-2 py-4 border border-indigo-dark">
                          {" "}
                          Allocate funds for AM Research in IITs and IIMs{" "}
                        </td>
                        <td className="px-2 py-4 border border-indigo-dark">
                          {" "}
                      ...
                      <tr>
                        <td className="px-2 py-4 border border-indigo-dark">
                          {" "}
                          Host a Summit on AM research from India
                        </td>
                        <td className="px-2 py-4 border border-indigo-dark">
                          {" "}
